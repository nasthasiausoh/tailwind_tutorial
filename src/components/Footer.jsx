...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
        {/* mx-auto so that it is sitting in the middle of the screen */}
        <div>
            <h1 className='w-full text-3xl font-bold text-[#00df9a]'>REACT.</h1>
            <p className='py-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur nam hic beatae id. Mollitia porro, cupiditate enim laudantium vel distinctio.</p>  
